...
class ImageClassificationDataset(torchvision.datasets.vision.VisionDataset):
    ...
    def get_normalization_statistics():
        """ Returns pre-computed channel-wise mean and standard deviation if available.
        
        These statistics are static and independent of the given dataset split.
        They have been pre-computed in advance for this type of dataset on the
        standard trainval split.

        If pre-computed statistics are unavailable for this dataset,
